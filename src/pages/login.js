            ...
            <div className="row no-gutters slider-text align-items-center">
              ...
              <div className="col-lg-5 col-md-6 d-flex align-items-end">
                ...
                <form className="bg-light p-5 contact-form" style={{width : '64vh'}}>
                  <h2 className="text-center gray">Login</h2>
                  <div className="form-group">
                    <input type="text" className="form-control" placeholder="Enter your Email ID" />
                  </div>
                  <div className="form-group">
                    <input type="text" className="form-control" placeholder="Enter your Passoword" />
                  </div>
                  <div className="form-group">
                    <NavLink to="/forget-passowrd"><p className="forget-password">Forget Password ?</p></NavLink>
                  </div>
                  <div className="form-group">
                    <input type="button" value="Login" className="btn btn-primary py-3 px-5" />
                  </div>
                </form>
              </div>
            </div>
